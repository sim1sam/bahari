<style>
    ...
    .order-item-image-cell .order-item-image-preview {
        align-self: center;
    }

    .order-item-image-cell .item-image-url {
        font-size: 0.72rem;
    ...
    .order-item-card.is-marked-delete {
        opacity: 0.45;
        border-color: #fca5a5;
        background: #fff7f7;
    }
    ...
    .order-item-card .form-group label {
        font-size: 0.82rem;
        font-weight: 600;
        color: #334155;
    ...
    .order-item-image-block .order-item-image-preview {
        width: 3.25rem;
        height: 3.25rem;
        flex-shrink: 0;
    }

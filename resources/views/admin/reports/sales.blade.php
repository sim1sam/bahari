...
@section('content')
    ...
    @include('admin.reports.partials.filters', [
        ...
        'exportExcelRoute' => route('admin.reports.sales', array_merge($filters->toQueryArray(), ['export' => 'excel'])),
        'exportCsvRoute' => route('admin.reports.sales', array_merge($filters->toQueryArray(), ['export' => 'csv'])),

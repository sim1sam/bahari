...
@section('page_subtitle', 'Account links and settings')
...
@section('content')
    @php
        $items = [
            ...
            ['label' => 'Wishlist', 'route' => 'account.wishlist', 'icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z'],
            ...
            ['label' => 'Ledger', 'route' => 'account.ledger', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
    ...
    {{-- Desktop --}}
    <div class="hidden lg:block px-8 pt-8 max-w-xl">
        <div class="account-panel">
            <div class="account-panel-header"><h2 class="font-semibold">Account Menu</h2></div>
